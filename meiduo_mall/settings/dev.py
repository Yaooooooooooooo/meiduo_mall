...
SECRET_KEY = 'nf)f$vmb3yxtvphic(e1@!$j2z3&9^@r_3vq4+($r(d%&()kg('
...
# 指定自定义的用户认证后端:
AUTHENTICATION_BACKENDS = ['users.utils.UsernameMobileBackendAuthentication']
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://...:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
