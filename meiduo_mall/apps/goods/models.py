...
class Goods(BaseModel):
    ...
    desc_detail = models.CharField(default='', max_length=200, verbose_name='商品描述')
    desc_pack = models.CharField(default='', max_length=200, verbose_name='商品包装')
    desc_service = models.CharField( default='', max_length=200, verbose_name='商品服务')
